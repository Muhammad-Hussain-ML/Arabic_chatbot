...
def chat_interface():
                                ...
                                5 if st.session_state["language"] == "EMRChains" else (
                                    6 if st.session_state["language"] == "EMRChains_Arabic" else (
                                        7  if st.session_state["language"] == "CDC" else (
                                            8  if st.session_state["language"] == "CDC-URDU" else (
                                                9  if st.session_state["language"] == "Medxol" else 0
                                            )
                                        )
                                    )
                                )
    ...
    elif st.session_state["language"] == "Medxol":
        unique_id = os.getenv("Unique_ID_Medxol")
    else :
